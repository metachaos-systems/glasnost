...
# GlasnostWeb.Endpoint.load_from_system_env/1 dynamically.
...
config :glasnost, GlasnostWeb.Endpoint,
  on_init: {GlasnostWeb.Endpoint, :load_from_system_env, []},
...
# start per endpoint:
#
#     config :glasnost, GlasnostWeb.Endpoint, server: true
#
